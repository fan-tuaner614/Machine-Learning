...
def main():
    ...
    print("Running Complete Linkage Clustering...")
    ...
    plot_results(X_vis, y, mapped_labels, "Complete Linkage", os.path.dirname(__file__))

    # 保存混淆矩阵
    plot_confusion(y, mapped_labels, os.path.join(os.path.dirname(__file__), "complete_linkage_confusion.png"), "Complete Linkage Confusion Matrix")
